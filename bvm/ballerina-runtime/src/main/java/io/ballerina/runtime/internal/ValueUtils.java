...
//    // below one is not needed
//    public static BMap<BString, Object> createEmptyRecordValue(Module packageId, String recordTypeName) {
//        ValueCreator valueCreator = ValueCreator.getValueCreator(ValueCreator.getLookupKey(packageId, false));
//        try {
...
//    }
    ...
    private static BMap<BString, Object> populateRecordDefaultValues(BMap<BString, Object> recordValue, Map<String, BFunctionPointer<Object, ?>> defaultValues) {
